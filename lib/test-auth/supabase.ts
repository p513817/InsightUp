  ...
  const { error: summaryError } = await admin.from("llm_trend_daily_summaries").upsert(
    {
      ...
      summary_text: JSON.stringify({
        ...
        keyChanges: ["Body fat percentage moved from 29.4% to 22.8%.", "Skeletal muscle increased from 25.1kg to 28.0kg."],
