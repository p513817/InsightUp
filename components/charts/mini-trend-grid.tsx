        ...
        <div className="flex min-w-0 items-center gap-2">
          {editMode ? (
            ...
            <button
              ...
              className="grid size-7 shrink-0 touch-none cursor-grab place-items-center rounded-full text-muted-foreground transition-[background-color,color,transform] duration-180 ease-[cubic-bezier(0.32,0.72,0,1)] hover:bg-primary/7 hover:text-primary active:scale-[0.94] active:rotate-3 active:cursor-grabbing active:bg-primary/10"
