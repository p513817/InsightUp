...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 rounded-full text-sm font-semibold transition duration-150 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 active:scale-[0.96] active:brightness-95",
  {
    variants: {
      variant: {
        default:
      ...
      size: {
        ...
        sm: "h-9 px-4 text-xs",
        lg: "h-12 px-6",
        icon: "size-11 rounded-full px-0 active:scale-[0.92] active:rotate-6 active:brightness-95",
      },
    },
    defaultVariants: {
      variant: "default",
