...
export const ROUND_ACTION_FEEDBACK_CLASS = "transition-[transform,background-color,opacity,box-shadow] duration-200 active:scale-[0.92] active:rotate-90 active:brightness-95";
export const FAB_BASE_CLASS =
  `${FAB_SIZE_CLASS} shrink-0 overflow-hidden rounded-full p-0 ${ROUND_ACTION_FEEDBACK_CLASS}`;
