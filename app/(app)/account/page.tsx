...
export default async function AccountPage() {
  ...
  return (
    <div>
      <section className="relative overflow-hidden rounded-[1.75rem] border border-border/45 bg-transparent px-5 py-5 sm:rounded-[2rem] sm:px-8 sm:py-7">
              ...
              <div className="rounded-[1rem] border border-white/45 bg-[rgba(255,255,255,0.34)] p-4 backdrop-blur-[4px]">
                ...
                <div className="mt-3 flex items-start gap-2.5">
                  {summary.avatarUrl ? (
                    ...
                    <div className="flex size-11 items-center justify-center rounded-full border border-border bg-[linear-gradient(135deg,rgba(121,215,195,0.32),rgba(28,54,95,0.10))] text-sm font-semibold text-foreground shadow-[0_6px_14px_rgba(16,35,63,0.07)] sm:size-12">
